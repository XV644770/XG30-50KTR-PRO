...
#ifndef F2807x_CLA_TYPEDEFS_H_
#define F2807x_CLA_TYPEDEFS_H_
...
#else
#error F2807x_Cla_Typedefs.h must be included before F2807x_Device.h or any other header \
