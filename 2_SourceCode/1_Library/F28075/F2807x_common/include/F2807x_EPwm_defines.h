...
#ifndef F2807x_EPWM_DEFINES_H
#define F2807x_EPWM_DEFINES_H
...
// RED = DBRED * TBCL
#define PWM_DBED_TIME	192			// 192/120MHz = 1.6us
...
/* 1us deadband with 75MHz TBCLK, 1*75 = 75 */
#define DeadBand_1us       	75
#define DeadBand_2us       	150
#define DeadBand_3us       	225
#define DeadBand_4us       	300
#define DeadBand_5us       	375
#define DeadBand_6us       	450
#define DeadBand_7us       	525
#define DeadBand_8us       	600
#define DeadBand_9us       	675
#define DeadBand_10us      	750


/* Define Macros for system level clock parameters */
#define SYSCLOCK_FREQ		120000000
#define TB_DIVx				(TB_DIV1)
#define HSPCLK_FREQ			(SYSCLOCK_FREQ>>1)      			// defined in SysCtrlRegs
#define LSPCLK_FREQ			(SYSCLOCK_FREQ>>2)      			// defined in SysCtrlRegs
#define TBCLK_FREQ			(SYSCLOCK_FREQ>>TB_DIVx)     			// EPwm Timer clock

#define PWM_SWITCH_FREQ  	19200

// TBCTL (Time-Base Control)
/* Period = SYSCLK_FREQ/INV_PWM_FREQ/2 = 120MHz/19200/2 = 3125 */
#define	PWM_INV_PERIOD		3125
#define PWM_INV_DUTY_MAX	3124
#define PWM_INV_DUTY_MIN	1

#define PWM_BOOST_PERIOD_PLUS	1562//3125
#define PWM_BOOST_DUTY_MAX_PLUS	1250// 1250/1562=80%//2500	// 2500/3125 = 80%	D=(Vout-Vin)/Vout = (1000-200)/1000 = 80%
#define PWM_BOOST_DUTY_MAX_PRO	1280// 1280/1562=81.9%//2500	// 2500/3125 = 80%	D=(Vout-Vin)/Vout = (1000-200)/1000 = 80%

#define PWM_BOOST_PERIOD	3125
#define PWM_BOOST_DUTY_MAX	2500	// 2500/3125 = 80%	D=(Vout-Vin)/Vout = (1000-200)/1000 = 80%


#define TZ_PROTECT_ENABLE		1

extern void InitEPwm(void);
extern void StartEPwm(void);
extern void CfgInvPwmDB(void);
extern void CfgBoostPwmInterlace(unsigned int uwBoostNo);

#ifdef __cplusplus
}
#endif /* extern "C" */

#endif   // - end of F2807x_EPWM_DEFINES_H
