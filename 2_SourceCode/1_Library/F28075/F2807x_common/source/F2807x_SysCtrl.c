//###########################################################################
//
// FILE:   F2807x_SysCtrl.c
//
// TITLE:  F2807x Device System Control Initialization & Support Functions.
//
// DESCRIPTION:
//
...
void InitPeripheralClocks(void)
{
    ...
    CpuSysRegs.PCLKCR2.bit.EPWM1 = 1;		// R-Phase 1,3
    CpuSysRegs.PCLKCR2.bit.EPWM2 = 1;		// R-Phase 2,4
    CpuSysRegs.PCLKCR2.bit.EPWM3 = 1;		// S-Phase 1,3
    CpuSysRegs.PCLKCR2.bit.EPWM4 = 1;		// S-Phase 2,4
    CpuSysRegs.PCLKCR2.bit.EPWM5 = 1;		// reserve
    CpuSysRegs.PCLKCR2.bit.EPWM6 = 1;		// T-Phase 1,3
    CpuSysRegs.PCLKCR2.bit.EPWM7 = 1;		// T-Phase 2,4
    CpuSysRegs.PCLKCR2.bit.EPWM8 = 1;		// BOOST-1
    CpuSysRegs.PCLKCR2.bit.EPWM9 = 1;		// BOOST-2
    CpuSysRegs.PCLKCR2.bit.EPWM10 = 1;		// BOOST-3
    CpuSysRegs.PCLKCR2.bit.EPWM11 = 1;		// BOOST-4
    CpuSysRegs.PCLKCR2.bit.EPWM12 = 1;		// fan pwm
    ...
    CpuSysRegs.PCLKCR7.bit.SCI_A = 1;		// SCI_A -> DEBUG
    CpuSysRegs.PCLKCR7.bit.SCI_B = 1;		// SCI_B ->
    CpuSysRegs.PCLKCR7.bit.SCI_C = 1;		// SCI_C ->
