//###########################################################################
//
// FILE:   F2807x_pievect.h
//
// TITLE:  F2807x Device PIE Vector Table Definitions
//
//###########################################################################
...
#ifndef F2807x_PIE_VECT_H
#define F2807x_PIE_VECT_H
#ifdef __cplusplus
extern "C" {
#endif
...
struct PIE_VECT_TABLE {
    ...
    PINT  PIE15_RESERVED_INT;                         // 4.7 - Reserved 
    PINT  PIE16_RESERVED_INT;                         // 4.8 - Reserved 
    ...
    PINT  PIE22_RESERVED_INT;                         // 7.7 - Reserved 
    PINT  PIE23_RESERVED_INT;                         // 7.8 - Reserved 
    ...
    PINT  PIE24_RESERVED_INT;                         // 12.4 - Reserved 
    PINT  PIE25_RESERVED_INT;                         // 12.5 - Reserved 
    ...
    PINT  PIE26_RESERVED_INT;                         // 1.9 - Reserved 
    PINT  PIE27_RESERVED_INT;                         // 1.10 - Reserved 
    PINT  PIE28_RESERVED_INT;                         // 1.11 - Reserved 
    PINT  PIE29_RESERVED_INT;                         // 1.12 - Reserved 
    ...
    PINT  PIE30_RESERVED_INT;                         // 2.13 - Reserved 
    PINT  PIE31_RESERVED_INT;                         // 2.14 - Reserved 
    PINT  PIE32_RESERVED_INT;                         // 2.15 - Reserved 
    PINT  PIE33_RESERVED_INT;                         // 2.16 - Reserved 
    ...
    PINT  PIE34_RESERVED_INT;                         // 3.13 - Reserved 
    PINT  PIE35_RESERVED_INT;                         // 3.14 - Reserved 
    PINT  PIE36_RESERVED_INT;                         // 3.15 - Reserved 
    PINT  PIE37_RESERVED_INT;                         // 3.16 - Reserved 
    PINT  PIE38_RESERVED_INT;                         // 4.9 - Reserved 
    PINT  PIE39_RESERVED_INT;                         // 4.10 - Reserved 
    PINT  PIE40_RESERVED_INT;                         // 4.11 - Reserved 
    PINT  PIE41_RESERVED_INT;                         // 4.12 - Reserved 
    PINT  PIE42_RESERVED_INT;                         // 4.13 - Reserved 
    PINT  PIE43_RESERVED_INT;                         // 4.14 - Reserved 
    PINT  PIE44_RESERVED_INT;                         // 4.15 - Reserved 
    PINT  PIE45_RESERVED_INT;                         // 4.16 - Reserved 
    PINT  SD1_INT;                                    // 5.9 - SD1 Interrupt 
    PINT  SD2_INT;                                    // 5.10 - SD2 Interrupt 
    PINT  PIE46_RESERVED_INT;                         // 5.11 - Reserved 
    PINT  PIE47_RESERVED_INT;                         // 5.12 - Reserved 
    PINT  PIE48_RESERVED_INT;                         // 5.13 - Reserved 
    PINT  PIE49_RESERVED_INT;                         // 5.14 - Reserved 
    PINT  PIE50_RESERVED_INT;                         // 5.15 - Reserved 
    PINT  PIE51_RESERVED_INT;                         // 5.16 - Reserved 
    PINT  SPIC_RX_INT;                                // 6.9 - SPIC Receive Interrupt 
    PINT  SPIC_TX_INT;                                // 6.10 - SPIC Transmit Interrupt 
    PINT  PIE52_RESERVED_INT;                         // 6.11 - Reserved 
    PINT  PIE53_RESERVED_INT;                         // 6.12 - Reserved 
    PINT  PIE54_RESERVED_INT;                         // 6.13 - Reserved 
    PINT  PIE55_RESERVED_INT;                         // 6.14 - Reserved 
    PINT  PIE56_RESERVED_INT;                         // 6.15 - Reserved 
    PINT  PIE57_RESERVED_INT;                         // 6.16 - Reserved 
    PINT  PIE58_RESERVED_INT;                         // 7.9 - Reserved 
    PINT  PIE59_RESERVED_INT;                         // 7.10 - Reserved 
    PINT  PIE60_RESERVED_INT;                         // 7.11 - Reserved 
    PINT  PIE61_RESERVED_INT;                         // 7.12 - Reserved 
    PINT  PIE62_RESERVED_INT;                         // 7.13 - Reserved 
    PINT  PIE63_RESERVED_INT;                         // 7.14 - Reserved 
    PINT  PIE64_RESERVED_INT;                         // 7.15 - Reserved 
    PINT  PIE65_RESERVED_INT;                         // 7.16 - Reserved 
    PINT  PIE66_RESERVED_INT;                         // 8.9 - Reserved 
    PINT  PIE67_RESERVED_INT;                         // 8.10 - Reserved 
    PINT  PIE68_RESERVED_INT;                         // 8.11 - Reserved 
    PINT  PIE69_RESERVED_INT;                         // 8.12 - Reserved 
    PINT  PIE70_RESERVED_INT;                         // 8.13 - Reserved 
    PINT  PIE71_RESERVED_INT;                         // 8.14 - Reserved 
    PINT  PIE72_RESERVED_INT;                         // 8.15 - Reserved 
    PINT  PIE73_RESERVED_INT;                         // 8.16 - Reserved 
    PINT  PIE74_RESERVED_INT;                         // 9.9 - Reserved 
    PINT  PIE75_RESERVED_INT;                         // 9.10 - Reserved 
    PINT  PIE76_RESERVED_INT;                         // 9.11 - Reserved 
    PINT  PIE77_RESERVED_INT;                         // 9.12 - Reserved 
    PINT  PIE78_RESERVED_INT;                         // 9.13 - Reserved 
    PINT  PIE79_RESERVED_INT;                         // 9.14 - Reserved 
    PINT  USBA_INT;                                   // 9.15 - USBA Interrupt 
    PINT  PIE80_RESERVED_INT;                         // 9.16 - Reserved 
    PINT  PIE81_RESERVED_INT;                         // 10.9 - Reserved 
    PINT  PIE82_RESERVED_INT;                         // 10.10 - Reserved 
    PINT  PIE83_RESERVED_INT;                         // 10.11 - Reserved 
    PINT  PIE84_RESERVED_INT;                         // 10.12 - Reserved 
    ...
    PINT  PIE85_RESERVED_INT;                         // 11.9 - Reserved 
    PINT  PIE86_RESERVED_INT;                         // 11.10 - Reserved 
    PINT  PIE87_RESERVED_INT;                         // 11.11 - Reserved 
    PINT  PIE88_RESERVED_INT;                         // 11.12 - Reserved 
    PINT  PIE89_RESERVED_INT;                         // 11.13 - Reserved 
    PINT  PIE90_RESERVED_INT;                         // 11.14 - Reserved 
    PINT  PIE91_RESERVED_INT;                         // 11.15 - Reserved 
    PINT  PIE92_RESERVED_INT;                         // 11.16 - Reserved 
